<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPrincipal.Master" AutoEventWireup="true" CodeBehind="CCliente.aspx.cs" Inherits="PrjVendas.CCliente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card efeito_Panel_2">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div>
                            <asp:Label ID="Label1" runat="server" Text="Clientes Cadastrados"></asp:Label>
                            <asp:GridView ID="grwCliente" runat="server" AutoGenerateColumns="False" DataKeyNames="IDCLIENTE" OnRowCommand="grwCliente_RowCommand" OnSelectedIndexChanged="grwCliente_SelectedIndexChanged">
                                <Columns>
                                    <asp:TemplateField HeaderText="CPF">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblCPF" runat="server" CommandArgument='<%#Eval("IDCLIENTE").ToString()+"|"+Container.DataItemIndex.ToString()%>'
                ...
                <div class="card-footer">
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <asp:Button ID="cmdExcluir" CssClass="btn btn-info" Width="100%" runat="server" Text="Excluir" Font-Bold="True" Enabled="False" OnClick="cmdExcluir_Click" />
                        </div>
                        <div class="col-md-3">
    ...
    <script>
            ...
            function aplicarDataTable() {
                var dt = $('#ContentPlaceHolder1_grwCliente').DataTable({
                "language": {
